...
@section('content')
    {{-- Cuerpo de mi index --}}
    <h1 class="text-center">Actualizar Producto {{ $product->idProduct }}</h1>
    <br>
    <div class="row">
                    ...
                    <form id="Formulario" action="/products/update/{{ $product->idProduct }}" method="POST"
                        ...
                        <div class="row mx-auto col-xxl-8 col-xl-9 col-lg-10 col-md-11 col-sm-12">
                            ...
                            <div class="col-lg-4 col-md-12 mt-3">
                                <label for="buyPrice" class="form-label">Precio Compra:</label>
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" id="buyPrice" name="buyPrice" min="0.01"
                                        step="0.01" value="{{ $product->buyPrice }}">
                                </div>
                                @error('buyPrice')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-lg-4 col-md-12 mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="sellPrice" name="sellPrice"
                                        min="0.01" step="0.01" value="{{ $product->sellPrice }}">
                                </div>
                                @error('sellPrice')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
