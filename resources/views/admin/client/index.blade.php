                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary p-2"
                                                href="/clients/edit/{{ $client->idClient }}">Modificar</a>
                                            {{-- @endif --}}
                                            {{-- boton para eliminar --}}
                                            <button class="btn btn-danger p-2"
                                                url="/clients/destroy/{{ $client->idClient }}"
                                                onclick="destroy(this, 'Se eliminara el cliente {{ $client->name }}','El cliente fue eliminado con exito')"
