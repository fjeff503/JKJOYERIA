...
{{-- Definimos el titulo --}}
@section('title', 'Estado Paquetes | Actualizar')
...
@section('content')
    {{-- Cuerpo de mi index --}}
    <h1 class="text-center">Actualizar Estados de Paquetes</h1>
    <br>
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card bg-light">
                <div class="card-body">
                    {{-- CUERPO PARA CREAR --}}
                    <form action="/package_states/update/{{ $data->idPackageState }}" method="POST">
                        @csrf
                        @method('PUT')
