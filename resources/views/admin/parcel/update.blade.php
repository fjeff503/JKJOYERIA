...
{{-- Definimos el titulo --}}
@section('title', 'Encomendistas | Actualizar')
...
@section('content')
    {{-- Cuerpo de mi index --}}
    <h1 class="text-center">Actualizar Encomendistas</h1>
    <br>
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card bg-light">
                <div class="card-body">
                    {{-- CUERPO PARA CREAR --}}
                    <form action="/parcels/update/{{ $parcel->idParcel }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row m-auto col-xxl-8 col-xl-9 col-lg-10 col-md-11 col-sm-12">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre" id="name"
                                    name="name" maxlength="50" value="{{ $parcel->name }}">
                                @error('name')
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mt-4">
                                ...
                                <input type="text" class="form-control" placeholder="Teléfono" id="phone"
                                    name="phone" maxlength="9" value="{{ $parcel->phone }}">
                                @error('phone')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mt-4">
                                ...
                                <input type="text" class="form-control" placeholder="WhatsApp" id="whatsapp"
                                    name="whatsapp" maxlength="9" value="{{ $parcel->whatsapp }}">
                                @error('whatsapp')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
