...
{{-- Definimos el titulo --}}
@section('title', 'Estado Pago | Actualizar')
...
@section('content')
    {{-- Cuerpo de mi index --}}
    <h1 class="text-center">Actualizar Estados de Pago</h1>
    <br>
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card bg-light">
                <div class="card-body">
                    {{-- CUERPO PARA CREAR --}}
                    <form action="/payment_states/update/{{ $data->idPaymentState }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row m-auto col-xxl-8 col-xl-9 col-lg-10 col-md-11 col-sm-12">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre" id="name"
                                    name="name" maxlength="15" value="{{ $data->name }}">
                                @error('name')
                            ...
                            <div class="col-12 text-center pt-3">
                                ...
                                <a class="mt-2 btn btn-dark btn-md col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-5"
                                    href="/payment_states">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
