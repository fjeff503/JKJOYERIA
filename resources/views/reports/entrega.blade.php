...
<body class="cuerpo">
    ...
    <table class="tabla">
        ...
        <tr>
            <td class="clave"><strong>Destino:</strong></td>
            <td class="valor" colspan="3">{{ $entrega->destino ?? 'No definido' }}</td>
        </tr>
        <tr>
            <td class="clave"><strong>Día:</strong></td>
            <td class="valor2">{{ $entrega->dia ?? 'No definido' }}</td>
            <td class="clave"><strong>Hora:</strong></td>
            <td class="valor2">{{ $entrega->hora ?? 'No definido' }}</td>
        </tr>
        <tr>
