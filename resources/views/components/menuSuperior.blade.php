    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar navbar-dark bg-dark">
        {{-- Logos responsivos --}}
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center navbar-dark bg-dark">
          <a class="navbar-brand brand-logo mr-0" href="/"><img src="{{ asset('melody/images/logo.png') }}" alt="logo"></a>
          <a class="navbar-brand brand-logo-mini" href="/"><img src="{{ asset('melody/images/logo-mini.svg') }}" alt="logo">
          </a>
        </div>
